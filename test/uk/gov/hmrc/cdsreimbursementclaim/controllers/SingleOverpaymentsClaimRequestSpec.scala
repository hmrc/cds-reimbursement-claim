          ...
          claim = SingleOverpaymentsClaim(
            ...
            claimantInformation = ClaimantInformation(
              ...
              establishmentAddress = ContactInformation(
                ...
                street = Some("claim.claimantInformation.establishmentAddress.street.map(_.take(70))"),
              ...
              contactInformation = ContactInformation(
                ...
                street = Some("claim.claimantInformation.contactInformation.street.map(_.take(70))"),
