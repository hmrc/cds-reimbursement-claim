...
class MultipleRejectedGoodsClaimMappingSpec
  ...
  "The Reject Goods claim mapper" should {
        ...
        details should have(
          ...
          Symbol("EORIDetails")(
            EoriDetails(
              ...
              agentEORIDetails = {
                val declarantDetails    = leadDeclaration.displayResponseDetail.declarantDetails
    ...
    "fail to map invalid claim amount" in {
      val rejectedGoodsMultipleData = genMultipleRejectedGoodsClaimAllTypes.sample.get
      val (claim, declarations)     = rejectedGoodsMultipleData
      val updatedClaim              =
