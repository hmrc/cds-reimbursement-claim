...
//import uk.gov.hmrc.cdsreimbursementclaim.models.claim.{Country, MultipleOverpaymentsClaim, Street}
...
//
//    "map a valid claim to TPI05 request" in forAll(genOverpaymentsMultipleClaim) {
...
//
//        val (claim, displayDeclaration) = multipleOverpaymentsData
//        val leadDeclarant                   = displayDeclaration.head
//
//        inside(tpi05Request) {
...
//                      contactPerson = claim.claimantInformation.contactInformation.contactPerson,
//                      addressLine1 = claim.claimantInformation.contactInformation.addressLine1,
//                      addressLine2 = claim.claimantInformation.contactInformation.addressLine2,
//                      addressLine3 = claim.claimantInformation.contactInformation.addressLine3,
//                      street = Street.fromLines(
//                        claim.claimantInformation.contactInformation.addressLine1,
//                        claim.claimantInformation.contactInformation.addressLine2,
//                      ),
//                      postalCode = claim.claimantInformation.contactInformation.postalCode,
//                      city = claim.claimantInformation.contactInformation.city,
//                      countryCode = claim.claimantInformation.contactInformation.countryCode.value,
//                      emailAddress = claim.claimantInformation.contactInformation.emailAddress,
