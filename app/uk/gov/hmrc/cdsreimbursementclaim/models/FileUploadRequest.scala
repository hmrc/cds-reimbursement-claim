...
final case class ExecutionType(
  @xmlns(BifNS) performed: Option[EisTime] = None,
  @xmlns(BifNS) result: Result,
  @xmlns(BifNS) tool: String,
  @xmlns(BifNS) report: String
)
...
final case class BatchFileInterfaceMetadata(
  @xmlns(BifNS) sourceSystem: String = "TPI",
...
object Dec64Body {
  ...
  implicit val compressionAlgorithmSimpleTypeEnc: ElementEncoder[CompressionAlgorithmSimpleType] =
