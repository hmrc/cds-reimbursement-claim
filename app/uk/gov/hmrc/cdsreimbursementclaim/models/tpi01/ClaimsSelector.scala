...
/** Claims selector in the TPI01 request:
  *
  * O = All Overpayments(NDRC + Securities) only N = NDRC only S = Securities only U = Underpayments only A = All cases
  */
...
object ClaimsSelector extends EnumerationFormat[ClaimsSelector] {
  ...
  case object All extends ClaimsSelector {
    override val value: String = "A"
  }
  case object Overpayments extends ClaimsSelector {
    override val value: String = "O"
  }
  case object Ndrc extends ClaimsSelector {
    override val value: String = "N"
  }
  case object Securities extends ClaimsSelector {
    override val value: String = "S"
  }
  case object Underpayments extends ClaimsSelector {
    override val value: String = "U"
  }

  override lazy val values: Set[ClaimsSelector] =
