...
import uk.gov.hmrc.cdsreimbursementclaim.models.tpi02.ndrc.NdrcClaimDetails
import uk.gov.hmrc.cdsreimbursementclaim.models.tpi02.scty.SctyClaimDetails

final case class SpecificClaimResponse(
